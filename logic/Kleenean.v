...
{
  true := Kleeneans.true;  
  false := Kleeneans.false;

  equiv := Kleeneans.equiv;
  apart := Kleeneans.apart;
  ...
  distinct := Kleeneans.apart_sym _ _ Kleeneans.true_apart_false;
  defined_dec := Kleeneans.defined_dec;

  impl_respectful := Kleeneans.impl_respectful;
  impl_up := Kleeneans.impl_up;
  impl_down := Kleeneans.impl_down;
}.
